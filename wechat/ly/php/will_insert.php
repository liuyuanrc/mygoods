...
// 获取用户名和密码
	...
	mysql_query("insert into `bdm273381633_db`.`will`(`name`,`count`) values('$name','$count')");
	echo mysql_error();
//-------------------------------------------------------------------------------------------------------------
	...
	// if (!mysqli_connect_errno($db)) {
		...
		// }else if($type == '删除'){
		// 	// 删除用户
		// 	$sql = "DELETE FROM PC_home WHERE names='$names' AND imgs='$imgs' AND ms='$ms' AND price='$price' AND prices='prices' ";
		// 	$result = mysqli_query($db,$sql);
